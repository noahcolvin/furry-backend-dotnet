...
public class DatabaseFixture : IDisposable
{
  public List<StoreItem> StoreItems { get; private set; } = [
    new() { Id = "1", Name = "Item1", Description = "Description1", Price = 1.99m, Image = "https://example.com/image1.jpg", Categories = ["Category1", "Category2", "Dog"], About = ["About1", "About2"], Rating = 4.5},
    new() { Id = "2", Name = "Item2", Description = "Description2 here", Price = 2.99m, Image = "https://example.com/image2.jpg", Categories = ["Category2", "Category3", "Food", "Dog"], About = ["About1", "About2"], Rating = 3.5},
    ...
    new() { Id = "4", Name = "Item4 here", Description = "Description4", Price = 4.99m, Image = "https://example.com/image4.jpg", Categories = ["Category4", "Category5"], About = ["About1", "About2"], Rating = 4}
  ];
